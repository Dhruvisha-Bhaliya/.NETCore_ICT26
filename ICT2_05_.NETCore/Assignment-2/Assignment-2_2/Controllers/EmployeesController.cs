...
namespace Assignment_2_2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,EmployeeName,Email,Department,JoiningDate,IsActive")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeName,Email,Department,JoiningDate,IsActive")] Employee employee)
        {
        ...
        public IActionResult SearchByProjectName(string projectName)
        {
            ...
            .Where(e => e.ProjectAllocations.Any(pa => pa.Project.ProjectName.Contains(projectName)))
            .ToList();
