...
using RegistrationAppMVC.Models;

namespace RegistrationAppMVC.Controllers
{
    public class UsersController : Controller
    {
        private readonly Ict2inventoryManagementDbContext _context;

        public UsersController(Ict2inventoryManagementDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult LogIn(string username,string password)
        {
            ...
            //var result = _context.Users.Where(u => u.UserName == username)
